...
INSERT INTO `enroll` VALUES (10006,900300101,'Midterm',88),(10006,900300101,'Paper',90),(10006,900300120,'Final',91),(10007,900300101,'Final',77),(10007,900300101,'Midterm',78),(10007,900300101,'Project',82),(10008,900300101,'Assignment',60),(10008,900300101,'Final',85),(10008,900300101,'Midterm',77),(10009,900300101,'Final',88),(10009,900300101,'Midterm',81),(10009,900300101,'Midterm1',77),(10010,900300101,'Final',77),(10010,900300101,'Paper',90),(10010,900300101,'Project',72),(20085,900300101,'Final',73),(20198,900300102,'Final',84),(20199,900300103,'Final',77),(20622,900300107,'Final',43),(20627,900300108,'Final',50),(20654,900300113,'Final',61),(21138,900300119,'Final',82);
...
--
/*!50003 DROP FUNCTION IF EXISTS `calcGradePts` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `calcGradePts`(n INT) RETURNS tinyint(4)
BEGIN
DECLARE s tinyint;
if n between 93 and 100 then set s = 16;
elseif n between 90 and 92 then set s = 14.8;
elseif n between 87 and 89 then set s = 13.2;
elseif n between 83 and 86 then set s = 12;
elseif n between 80 and 82 then set s = 10.8;
elseif n between 77 and 79 then set s = 9.2;
elseif n between 73 and 76 then set s = 8;
elseif n between 70 and 72 then set s = 6.8;
elseif n between 67 and 69 then set s = 5.2;
elseif n between 63 and 66 then set s = 4;
elseif n between 60 and 62 then set s = 2.8;
else set s = 0;
end if;
return s;
END ;;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `gpa` AS select `classgrade`.`studentId` AS `studentId`,round((sum(`calcGradePts`(`classgrade`.`grade`)) / sum(`classgrade`.`creditHrs`)),2) AS `gpa` from `classgrade` group by `classgrade`.`studentId` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-04-30  9:53:33
